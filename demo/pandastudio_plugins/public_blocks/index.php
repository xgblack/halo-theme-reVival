...
function pandastudio_block_render_single($attributes) {
	...
	switch ($post_type) {
		case 'post':
			...
			$result = "
			<div class='".$class."' posttype='post'>
				<div class='single-wrapper'>
					<a class='cover' style='background-image:url(".$coverImg.")' href='".$href."'></a>
					<div class='single-meta'>
						<a class='post-title' href='".$href."'><h4>".$title."</h4></a>
						<div class='summary'>
							<span class='date'>
								<i class='pandastudio-icons-clock'></i>
								".$date."
							</span>
							<span class='likes'>
							...
							<span class='comments'>
								<i class='pandastudio-icons-comment'></i>
								".$comments."
							</span>
						</div>
					</div>
...
function pandastudio_block_render_gallery($attributes) {
	...
	for ($i=0; $i < count($images); $i++) {
		...
		$items = $i==0 ?
			$items.'<div class="item active">
				      <div class="img_wrapper"><img src="'.$images[$i].'"></div>
				    </div>'
	    	:
	...
	$result = '
	<div id="'.$id.'" class="gallery carousel slide" data-ride="carousel">
	  <!-- Indicators -->
	  ...
	  <a class="left carousel-control" href="#'.$id.'" role="button" data-slide="prev">
	    <i class="pandastudio-icons-left glyphicon-chevron-left"></i>
	    <span class="sr-only">Previous</span>
	  </a>
	  <a class="right carousel-control" href="#'.$id.'" role="button" data-slide="next">
	  	<i class="pandastudio-icons-right glyphicon-chevron-right"></i>
